...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    /**
     * Select all `.randomPizzaContainer` at once
     */
    var pizzas = document.querySelectorAll(".randomPizzaContainer");
    var pizzasCount = pizzas.length;

    /**
     * Calcuate the size of pizza only once
     */
    if (pizzasCount > 0) {
...
/**
 * Update the background pizza position
 * @return {null}
 *
 * Inorder to optimise the performance I have extract the
 * redundant part of collecting the same elements repeatedly
 * instead of collecting all of the necessary elements at once
 */
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  /**
   * Collect all rendered pizzas at onece instead of
   * collecting pizzas every-time updatePositons
   */
